#!/bin/bash
# setup-retroflag-shutdown.sh 
# Installs python script to enable safe shutdown of Raspberry Pi on PIN5/GPIO3 Logic HIGH
...
#  curl http://pie.8bitjunkie.net/shutdown/setup-retroflag-shutdown.sh | bash
...
echo; echo
echo -e "\e[96mThis script will install a python script to enable shutdown of Raspberry Pi upon PIN5/GPIO3 Logic HIGH\e[0m"
echo; echo
...
curl -# "http://pie.8bitjunkie.net/shutdown/shutdown-retroflag.py" > /home/pi/scripts/shutdown.py 
